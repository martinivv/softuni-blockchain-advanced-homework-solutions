...
import {CharityTournament} from "@/06_merkle-trees/CharityTournament.sol";
...
contract CharityTournamentTest is Test {
    ...
    function testParticipants() public view {
        bool isValid;
    ...
    function testNonParticipant() public view {
        bool isValid = tournament.isParticipant(nonParticipant, new bytes32[](0));
        assertFalse(isValid);
    }

    function testWrongProof() public view {
    ...
    function testEmptyProofForParticipant() public view {
        bool isValid = tournament.isParticipant(alice, new bytes32[](0));
        assertFalse(isValid);
    }

    function testZeroAddress() public view {
        address zeroAddr = address(0);
        bool isValid = tournament.isParticipant(zeroAddr, new bytes32[](0));
        assertFalse(isValid);
    }

    function testReusedProofForNonIncludedAddress() public view {
    ...
    function testProofFailsWithWrongRoot() public {
